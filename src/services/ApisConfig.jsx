...
export const API_URL_GET_WAREHOUSES_TRANSFERS = BASE_API_URL + "get_warehouse_transfer/";
export const API_URL_UPDATE_WAREHOUSES_TRANSFERS = BASE_API_URL + "update_warehouse_transfer/";
